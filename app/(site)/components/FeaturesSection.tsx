...
import { FileText, LineChart, MessageSquare, Zap, Target, Shield } from "lucide-react";
    ...
    <section id="ozellikler" className="max-w-7xl mx-auto px-6 mb-32 relative">
      <div className="text-center mb-20">
        ...
        >
            ...
            Kariyerin İçin <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Tam Donanım</span>
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
            Seni diğer adaylardan ayıracak, en son yapay zeka teknolojileriyle güçlendirilmiş araç seti.
            </p>
        </motion.div>
      </div>
