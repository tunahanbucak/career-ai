...
import { Geist, Geist_Mono } from "next/font/google"; // Fontları tekrar yüklememiz gerekebilir çünkü global-error kendi html/body'sini oluşturur
...
export default function GlobalError({
  ...
  return (
    <html lang="tr" className="dark h-full">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased h-full bg-[#020617] text-slate-100 flex items-center justify-center`}>
        <div className="max-w-md w-full p-8 text-center space-y-6">
          ...
          <p className="text-slate-400">
            Beklenmedik bir sorun oluştu ve uygulama yanıt veremiyor.
