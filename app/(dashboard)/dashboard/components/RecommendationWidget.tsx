      ...
      <div className="bg-slate-950/90 backdrop-blur-xl rounded-[22px] p-6 h-full flex flex-col justify-between relative z-10">
        <div>
          ...
          <p className="text-slate-400 text-sm mb-6 leading-relaxed">
            Son CV analizine göre, <strong>&quot;Liderlik&quot;</strong> yeteneklerini vurgulamak için mülakat pratiği yapman öneriliyor.
          </p>
        </div>
        
        <Button className="w-full bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 text-white font-bold shadow-lg shadow-orange-500/25" asChild>
            <Link href="/interview">
