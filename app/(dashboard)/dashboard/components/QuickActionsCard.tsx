    ...
    <>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-sm font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400">
            Hızlı İşlemler
          </h3>
        </div>
        <motion.div
        ...
        >
          ...
          >
            ...
            />
            <span className="text-xs font-medium text-red-300 group-hover:text-red-200">
              Güvenli Çıkış
            </span>
          </motion.button>
        </motion.div>
