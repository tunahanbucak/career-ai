          ...
          <div className="grid gap-4">
            {user.cvs.length === 0 ? (
              ...
              user.cvs.map((cv) => (
                <Card
                  key={cv.id}
                  className="bg-slate-900/40 border-slate-800 hover:border-emerald-500/50 transition-colors"
                >
          ...
          <div className="grid gap-4">
            {user.interviews.length === 0 ? (
              ...
              user.interviews.map((interview) => (
                <Card
                  key={interview.id}
                  className="bg-slate-900/40 border-slate-800 hover:border-amber-500/50 transition-colors"
                >
                  <CardContent className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        <p className="text-xs text-slate-500 italic">
                          {interview._count.messages} Mesaj
                        </p>
