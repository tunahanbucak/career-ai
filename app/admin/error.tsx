...
export default function AdminError({
  ...
  useEffect(() => {
    // Hatayı loglama servisine gönderebilirsiniz (Opsiyonel)
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#020617] p-4 text-slate-100">
      ...
      >
        ...
        <p className="text-slate-400 mb-8 leading-relaxed">
          Admin paneli yüklenirken beklenmedik bir sorunla karşılaştık. 
          Lütfen tekrar deneyin veya sistem yöneticisi ile görüşün.
        </p>
