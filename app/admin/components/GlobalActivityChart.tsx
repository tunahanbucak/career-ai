...
export default function GlobalActivityChart({ data }: GlobalActivityChartProps) {
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/40 backdrop-blur-sm p-5 shadow-xl relative overflow-hidden group">
      ...
      <div className="relative z-10 mb-6 flex items-center justify-between">
         <div>
            ...
            <p className="text-xs text-slate-500 font-mono mt-1">Son 30 günlük işlem hacmi (CV & Mülakat)</p>
         </div>
      </div>
